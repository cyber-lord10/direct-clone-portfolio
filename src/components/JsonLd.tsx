...
export const JsonLd = () => {
	const personData = {
		...
		sameAs: [
			...
			'https://linkedin.com/in/jack-washington-7bb0873a3', // 'https://linkedin.com/in/nzenongbraxton',
			...
			'https://patreon.com/user?u=95811168',
			'https://pinterest.com/nzenongbraxton',
			'https://reddit.com/user/Select-Influence-466',
			'https://ebay.com/usr/nzenongbraxton',
			'https://open.spotify.com/user/31f23n7xh6sxx4d3ipztrrmbd3j4',
			'https://strava.com/athletes/200494013',
