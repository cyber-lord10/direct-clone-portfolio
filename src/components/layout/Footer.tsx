...
import { Terminal, Phone, MapPin, Mail, MessageCircle, Send, Download } from "lucide-react";
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm mb-6">
              Full Stack Developer & SEO Specialist crafting premium digital experiences from Cameroon.
            </p>
            <motion.a
              href="/resume.pdf"
          ...
          <nav aria-label="Footer navigation">
            <h2 className="font-display font-bold text-foreground mb-6">Quick Links</h2>
          ...
          {/* Contact Info */}
          <div>
            <h2 className="font-display font-bold text-foreground mb-6">Contact</h2>
            <address className="not-italic space-y-4">
              {/* Phones */}
              <div className="flex items-start gap-3">
                <Phone size={18} className="text-primary mt-1 flex-shrink-0" aria-hidden="true" />
              ...
              <div className="flex items-center gap-3">
                <MessageCircle size={18} className="text-primary flex-shrink-0" aria-hidden="true" />
                <a
              ...
              {/* Telegram */}
              <div className="flex items-center gap-3">
                <Send size={18} className="text-primary flex-shrink-0" aria-hidden="true" />
                <a
          ...
          {/* Email */}
          <div>
            <h2 className="font-display font-bold text-foreground mb-6">Email</h2>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                <Mail size={18} className="text-primary mt-1 flex-shrink-0" aria-hidden="true" />
                <div className="text-sm">
