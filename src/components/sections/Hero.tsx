    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden" aria-labelledby="hero-heading">
      ...
      <div className="container relative z-10 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Main Title */}
          <FadeIn delay={0.4}>
            <h1 id="hero-heading" className="font-display text-4xl md:text-6xl lg:text-7xl font-bold mb-4 tracking-tight">
          ...
          <FadeIn delay={1}>
            <p className="text-lg md:text-xl text-muted-foreground font-body mb-8 max-w-2xl mx-auto">
              <span className="text-primary">Full Stack Developer & SEO Specialist</span> crafting digital experiences 
              with code, creativity, and a passion for innovation
            </p>
          </FadeIn>
          ...
          <FadeIn delay={1.4}>
            <div className="flex items-center justify-center gap-6">
              {[
                { icon: Github, href: "https://github.com/braxtonnzenong", label: "GitHub Profile" },
                { icon: Linkedin, href: "https://linkedin.com/in/nzenongbraxton", label: "LinkedIn Profile" },
                { icon: Mail, href: "mailto:contact@nzenongbraxton.com", label: "Send Email" },
